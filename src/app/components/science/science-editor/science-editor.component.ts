...
@Component({
  selector: 'app-science-editor',
  templateUrl: './science-editor.component.html',
  styleUrls: ['./science-editor.component.scss']
})
export class ScienceEditorComponent implements OnInit {
